...
public class Node implements Runnable {
    ...
    //private final String config_file_path = "C:\\Users\\Vimal\\Documents\\NetBeansProjects\\AdvancedOperatingSystem\\src\\Project1\\configuration.txt";
    ...
    private void createFile(boolean inititate) throws IOException {
        PrintWriter writer = new PrintWriter("config-vkumaa6a-" + identifier + ".out", "UTF-8");
        writer.print("Net ID: vkumaa6a");
        writer.print("\nNode ID: " + identifier);
